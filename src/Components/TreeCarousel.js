...
export default class TreeCarousel extends Component {
  rightNavBtn
  leftNavBtn
  componentDidMount=()=>{
  ...
  render() {
    return (
      <div className="carouselContainer">
        ...
        >
          <div className="carousel-cell-tree">
            <img src={carouselImage} alt="carousel item 1" style={{height:"100%"}} />
          </div>
          <div className="carousel-cell-tree">
            <img src={carouselImage2} alt="carousel item 2" style={{height:"100%"}}/>
          </div>
          <div className="carousel-cell-tree">
            <img src={carouselImage} alt="carousel item 1" style={{height:"100%"}}/>
          </div>
